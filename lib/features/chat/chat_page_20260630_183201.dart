...
class _ChatPageState extends ConsumerState<ChatPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final commonTopics = peer.commonTags(me.tags);
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(lang == 'en' ? 'Shared:' : '你们聊过：', style: AppTextStyles.caption),
                      ...
                      Expanded(
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              for (final t in commonTopics)
                                Padding(
                                  padding: const EdgeInsets.only(right: 6),
                                  child: IpTagChip(tag: t, small: true),
                                ),
                            ],
                          ),
                        ),
