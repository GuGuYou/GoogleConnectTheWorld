...
class ActivityItem {
  ...
  final List<String> candidateSeeds; // 候补池：差人时智能补齐
  bool joined;
  bool checkedIn;
  ...
  /// 是否差人（用于"一键约起"凑人）
  bool get needsMore => participants < maxParticipants;
  int get vacancy => (maxParticipants - participants).clamp(0, 999);
}
